...
export const Delivery = (props: IDeliveryProps) => {
  ...
  const { deliveryList, match, loading, totalItems } = props;
  return (
    <div>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('postOfficeNumber')}>
                  Post Office Number <FontAwesomeIcon icon="sort" />
                </th>
            ...
            <tbody>
              {deliveryList.map((delivery, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{delivery.postOfficeNumber}</td>
                  ...
                  <td className="text-right">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${delivery.id}/edit?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="primary"
                        size="sm"
                      >
                      ...
                      <Button
                        tag={Link}
                        to={`${match.url}/${delivery.id}/delete?page=${paginationState.activePage}&sort=${paginationState.sort},${paginationState.order}`}
                        color="danger"
                        size="sm"
                      >
      ...
      <div className={deliveryList && deliveryList.length > 0 ? '' : 'd-none'}>
