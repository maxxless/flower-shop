...
export const ACTION_TYPES = {
  SEARCH_DELIVERIES: 'delivery/SEARCH_DELIVERIES',
...
export default (state: DeliveryState = initialState, action): DeliveryState => {
  switch (action.type) {
    case REQUEST(ACTION_TYPES.SEARCH_DELIVERIES):
    ...
    case FAILURE(ACTION_TYPES.SEARCH_DELIVERIES):
...
const apiSearchUrl = 'api/_search/deliveries';
