...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_CATEGORY_LIST), REQUEST(ACTION_TYPES.SEARCH_CATEGORIES), REQUEST(ACTION_TYPES.FETCH_CATEGORY)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_CATEGORIES),
  ...
  describe('Successes', () => {
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_CATEGORIES),
          payload
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.SEARCH_CATEGORIES actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_CATEGORIES)
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_CATEGORIES),
          payload: resolvedObject
