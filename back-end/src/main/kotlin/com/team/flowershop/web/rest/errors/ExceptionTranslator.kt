package com.team.flowershop.web.rest.errors
...
class ExceptionTranslator : ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler
    fun handleEmailAlreadyUsedException(ex: com.team.flowershop.service.EmailAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
    ...
    @ExceptionHandler
    fun handleUsernameAlreadyUsedException(ex: com.team.flowershop.service.UsernameAlreadyUsedException, request: NativeWebRequest): ResponseEntity<Problem>? {
        val problem = LoginAlreadyUsedException()
        return create(problem, request, HeaderUtil.createFailureAlert(applicationName, false, problem.entityName, problem.errorKey, problem.message))
    }

    @ExceptionHandler
    fun handleInvalidPasswordException(ex: com.team.flowershop.service.InvalidPasswordException, request: NativeWebRequest): ResponseEntity<Problem>? {
