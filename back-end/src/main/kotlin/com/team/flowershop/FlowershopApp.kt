...
import com.team.flowershop.config.ApplicationProperties
...
class FlowershopApp(private val env: Environment) {

    private val log = LoggerFactory.getLogger(javaClass)

    /**
     * Initializes flowershop.
     *
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<FlowershopApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(FlowershopApp::class.java)
